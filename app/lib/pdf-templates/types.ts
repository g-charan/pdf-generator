...
export interface LetterOfCredit {
  ...
  toLabel: string;
  subjectLabel: string;
  bodyText1: string; // The main big paragraph
  bodyText2: string; // The "drawn under" paragraph
  closingText: string;
...
export type DocumentType = "invoice" | "credit_reference" | "credit_application" | "letter_of_credit";
